...
Version:        3.4.11
Release:        1%{?dist}
Summary:        ament_cmake integration for launch_testing

License:        Apache-2.0
URL:            https://github.com/ros2/launch
Source0:        https://github.com/ros2/launch/archive/refs/tags/3.4.11.tar.gz#/ros-jazzy-launch-testing-ament-cmake-3.4.11.tar.gz
...
%description
ament_cmake integration for launch_testing. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n launch-3.4.11
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f launch_testing_ament_cmake/LICENSE LICENSE 2>/dev/null || :
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths launch_testing_ament_cmake \
