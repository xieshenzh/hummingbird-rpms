...
Source0:        https://github.com/ros2/ros2cli/archive/refs/tags/0.32.12.tar.gz#/ros-jazzy-ros2cli-0.32.12.tar.gz
...
%description
Framework for ROS 2 command line tools. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ros2cli-0.32.12
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ros2cli/LICENSE LICENSE 2>/dev/null || :
