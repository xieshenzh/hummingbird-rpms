...
Version:        28.1.22
Release:        1%{?dist}
Summary:        Adds action APIs for C++

License:        Apache-2.0
URL:            https://github.com/ros2/rclcpp
Source0:        https://github.com/ros2/rclcpp/archive/refs/tags/28.1.22.tar.gz#/ros-jazzy-rclcpp-action-28.1.22.tar.gz
...
%description
Adds action APIs for C++. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
