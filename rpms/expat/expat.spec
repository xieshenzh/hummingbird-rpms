...
Version: 2.8.2
Release: 1%{?dist}
Source0: https://github.com/libexpat/libexpat/releases/download/R_2_8_2/expat-%{version}.tar.gz
Source1: https://github.com/libexpat/libexpat/releases/download/R_2_8_2/expat-%{version}.tar.gz.asc
