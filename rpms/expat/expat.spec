...
Version: 2.8.0
Release: 0.1%{?dist}
Source0: https://github.com/libexpat/libexpat/releases/download/R_2_8_0/expat-%{version}.tar.gz
Source1: https://github.com/libexpat/libexpat/releases/download/R_2_8_0/expat-%{version}.tar.gz.asc
