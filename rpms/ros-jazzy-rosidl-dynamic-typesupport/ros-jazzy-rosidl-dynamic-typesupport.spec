...
Version:        0.1.2
Release:        1%{?dist}
Summary:        Runtime dynamic type support for ROS interfaces

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_dynamic_typesupport
Source0:        https://github.com/ros2/rosidl_dynamic_typesupport/archive/refs/tags/0.1.2.tar.gz#/ros-jazzy-rosidl-dynamic-typesupport-0.1.2.tar.gz
...
%description
Runtime dynamic type support for ROS interfaces. Part of the ROS 2 Jazzy rosidl interface-generation stack,
installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rosidl_dynamic_typesupport-0.1.2
