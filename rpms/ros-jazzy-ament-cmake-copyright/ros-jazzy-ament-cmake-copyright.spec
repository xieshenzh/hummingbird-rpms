...
Version:        0.17.5
Release:        1%{?dist}
Summary:        ament_cmake copyright lint

License:        Apache-2.0
URL:            https://github.com/ament/ament_lint
Source0:        https://github.com/ament/ament_lint/archive/refs/tags/0.17.5.tar.gz#/ros-jazzy-ament-cmake-copyright-0.17.5.tar.gz
...
%description
ament_cmake copyright lint. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ament_lint-0.17.5
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ament_cmake_copyright/LICENSE LICENSE 2>/dev/null || :
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths ament_cmake_copyright \
