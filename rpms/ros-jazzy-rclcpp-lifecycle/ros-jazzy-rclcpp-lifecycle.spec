...
Version:        28.1.22
Release:        1%{?dist}
Summary:        Package providing lifecycle C++ API

License:        Apache-2.0
URL:            https://github.com/ros2/rclcpp
Source0:        https://github.com/ros2/rclcpp/archive/refs/tags/28.1.22.tar.gz#/ros-jazzy-rclcpp-lifecycle-28.1.22.tar.gz
...
%description
Package providing lifecycle C++ API. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
