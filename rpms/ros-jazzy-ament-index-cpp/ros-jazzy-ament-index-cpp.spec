...
%description
ament_index_cpp provides a C++ API to access the ament resource index: the
mechanism ROS 2 packages use to register and discover resources (packages,
