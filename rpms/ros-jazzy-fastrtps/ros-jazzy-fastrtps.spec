...
Version:        2.14.7
Release:        1%{?dist}
Summary:        eProsima Fast DDS C++ implementation of the OMG DDS standard

License:        Apache-2.0
URL:            https://github.com/eProsima/Fast-DDS
Source0:        https://github.com/eProsima/Fast-DDS/archive/refs/tags/v2.14.7.tar.gz#/ros-jazzy-fastrtps-2.14.7.tar.gz
...
%description
eProsima Fast DDS C++ implementation of the OMG DDS standard. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n Fast-DDS-2.14.7
...
colcon build \
    ...
    -DTHIRDPARTY_Asio=OFF -DTHIRDPARTY_TinyXML2=OFF -DTHIRDPARTY_fastcdr=OFF -DTHIRDPARTY_foonathan_memory=OFF \
    --base-paths . \
