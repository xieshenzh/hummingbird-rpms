...
Version:        9.2.11
Release:        1%{?dist}
Summary:        Parse YAML parameter files for rcl

License:        Apache-2.0
URL:            https://github.com/ros2/rcl
Source0:        https://github.com/ros2/rcl/archive/refs/tags/9.2.11.tar.gz#/ros-jazzy-rcl-yaml-param-parser-9.2.11.tar.gz
...
%description
Parse YAML parameter files for rcl. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    --base-paths rcl_yaml_param_parser \
