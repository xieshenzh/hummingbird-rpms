...
Version:        3.1.1
Release:        1%{?dist}
Summary:        No-op logging backend for rcl

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_logging
Source0:        https://github.com/ros2/rcl_logging/archive/refs/tags/3.1.1.tar.gz#/ros-jazzy-rcl-logging-noop-3.1.1.tar.gz
...
%description
No-op logging backend for rcl. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rcl_logging-3.1.1
...
colcon build \
    ...
    --base-paths rcl_logging_noop \
    --install-base %{buildroot}%{_libdir}/ros-jazzy/ \
    --packages-select rcl_logging_noop
