...
Version:        2.0.4
Release:        1%{?dist}
Summary:        ROS 2 messages for statistics collection

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_interfaces
Source0:        https://github.com/ros2/rcl_interfaces/archive/refs/tags/2.0.4.tar.gz#/ros-jazzy-statistics-msgs-2.0.4.tar.gz
...
%description
ROS 2 messages for statistics collection. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
