...
Version:        4.6.9
Release:        1%{?dist}
Summary:        Common Python API for ROS interface generation

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-pycommon-4.6.9.tar.gz
...
%description
Common Python API for ROS interface generation. Part of the ROS 2 Jazzy rosidl interface-generation stack,
