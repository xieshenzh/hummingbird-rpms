...
Version:        0.1.0
Release:        1%{?dist}
Summary:        Fast DDS serialization support for runtime dynamic types

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_dynamic_typesupport_fastrtps
Source0:        https://github.com/ros2/rosidl_dynamic_typesupport_fastrtps/archive/refs/tags/0.1.0.tar.gz#/ros-jazzy-rosidl-dynamic-typesupport-fastrtps-0.1.0.tar.gz
...
%description
Fast DDS serialization support for runtime dynamic types. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rosidl_dynamic_typesupport_fastrtps-0.1.0
