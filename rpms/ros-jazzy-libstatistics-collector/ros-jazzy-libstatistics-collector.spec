...
Version:        1.7.4
Release:        1%{?dist}
Summary:        Lightweight library for collecting runtime statistics

License:        Apache-2.0
URL:            https://github.com/ros-tooling/libstatistics_collector
Source0:        https://github.com/ros-tooling/libstatistics_collector/archive/refs/tags/1.7.4.tar.gz#/ros-jazzy-libstatistics-collector-1.7.4.tar.gz
...
%description
Lightweight library for collecting runtime statistics. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n libstatistics_collector-1.7.4
