...
Version:        7.3.4
Release:        1%{?dist}
Summary:        CMake macros to select the RMW implementation

License:        Apache-2.0
URL:            https://github.com/ros2/rmw
Source0:        https://github.com/ros2/rmw/archive/refs/tags/7.3.4.tar.gz#/ros-jazzy-rmw-implementation-cmake-7.3.4.tar.gz
...
%description
CMake macros to select the RMW implementation. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rmw-7.3.4
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rmw_implementation_cmake \
