...
Version:        8.2.6
Release:        1%{?dist}
Summary:        Tracing tools and instrumentation for ROS 2

License:        Apache-2.0
URL:            https://github.com/ros2/ros2_tracing
Source0:        https://github.com/ros2/ros2_tracing/archive/refs/tags/8.2.6.tar.gz#/ros-jazzy-tracetools-8.2.6.tar.gz
...
%description
Tracing tools and instrumentation for ROS 2. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ros2_tracing-8.2.6
