...
Version:        0.2.1
Release:        1%{?dist}
Summary:        Metapackage defining runtime dependencies for core ROS interfaces

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_core
Source0:        https://github.com/ros2/rosidl_core/archive/refs/tags/0.2.1.tar.gz#/ros-jazzy-rosidl-core-runtime-0.2.1.tar.gz
...
%description
Metapackage defining runtime dependencies for core ROS interfaces. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rosidl_core-0.2.1
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rosidl_core_runtime \
