...
Version:        2.5.6
Release:        1%{?dist}
Summary:        The ability to run Python tests using pytest in the ament buildsystem in CMake

License:        Apache-2.0
URL:            https://github.com/ament/ament_cmake
# Upstream ships all ament_cmake_* subpackages in one monorepo tarball; this
# spec carves out ament_cmake_pytest with colcon's --packages-select.
...
# buildtool_depend: ament_cmake_core, ament_cmake_test, python3-pytest
BuildRequires:  ros-jazzy-ament-cmake-core
BuildRequires:  ros-jazzy-ament-cmake-test
BuildRequires:  python3-pytest

# buildtool_export_depend -> Requires: consumers need the test harness and pytest.
...
Part of the ament buildsystem for ROS 2 Jazzy, installed under
%{_libdir}/ros-jazzy.
