...
Version:        2.0.4
Release:        1%{?dist}
Summary:        ROS 2 interfaces describing other ROS interface types

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_interfaces
Source0:        https://github.com/ros2/rcl_interfaces/archive/refs/tags/2.0.4.tar.gz#/ros-jazzy-type-description-interfaces-2.0.4.tar.gz
...
%description
ROS 2 interfaces describing other ROS interface types. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    --base-paths type_description_interfaces \
