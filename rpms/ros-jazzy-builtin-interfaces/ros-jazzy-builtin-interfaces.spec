...
Version:        2.0.4
Release:        1%{?dist}
Summary:        Messages for ROS 2 builtin types (time, duration)

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_interfaces
Source0:        https://github.com/ros2/rcl_interfaces/archive/refs/tags/2.0.4.tar.gz#/ros-jazzy-builtin-interfaces-2.0.4.tar.gz
...
%description
Messages for ROS 2 builtin types (time, duration). Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
