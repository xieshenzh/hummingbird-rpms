...
Version:        2.0.4
Release:        1%{?dist}
Summary:        ROS 2 services for runtime composition of nodes

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_interfaces
Source0:        https://github.com/ros2/rcl_interfaces/archive/refs/tags/2.0.4.tar.gz#/ros-jazzy-composition-interfaces-2.0.4.tar.gz
...
%description
ROS 2 services for runtime composition of nodes. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    --base-paths composition_interfaces \
