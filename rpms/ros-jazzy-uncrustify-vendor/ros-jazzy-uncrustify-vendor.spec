...
Version:        3.0.1
Release:        1%{?dist}
Summary:        Vendor package for uncrustify

License:        Apache-2.0
URL:            https://github.com/ament/uncrustify_vendor
Source0:        https://github.com/ament/uncrustify_vendor/archive/refs/tags/3.0.1.tar.gz#/ros-jazzy-uncrustify-vendor-3.0.1.tar.gz
...
%description
Vendor package for uncrustify. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n uncrustify_vendor-3.0.1
