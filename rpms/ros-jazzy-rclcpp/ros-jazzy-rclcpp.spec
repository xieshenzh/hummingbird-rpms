...
Version:        28.1.22
Release:        1%{?dist}
Summary:        The ROS 2 client library in C++

License:        Apache-2.0
URL:            https://github.com/ros2/rclcpp
Source0:        https://github.com/ros2/rclcpp/archive/refs/tags/28.1.22.tar.gz#/ros-jazzy-rclcpp-28.1.22.tar.gz
...
%description
The ROS 2 client library in C++. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
