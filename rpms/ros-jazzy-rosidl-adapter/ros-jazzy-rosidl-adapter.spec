...
Version:        4.6.9
Release:        1%{?dist}
Summary:        API and scripts to parse .msg/.srv files and convert them to .idl

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-adapter-4.6.9.tar.gz
...
%description
API and scripts to parse .msg/.srv files and convert them to .idl. Part of the ROS 2 Jazzy rosidl interface-generation stack,
