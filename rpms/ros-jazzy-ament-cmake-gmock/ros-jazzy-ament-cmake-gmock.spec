...
Version:        2.5.6
Release:        1%{?dist}
Summary:        The ability to add GMock-based tests in the ament buildsystem in CMake

License:        Apache-2.0
URL:            https://github.com/ament/ament_cmake
# Upstream ships all ament_cmake_* subpackages in one monorepo tarball; this
# spec carves out ament_cmake_gmock with colcon's --packages-select.
...
# buildtool_export_depend -> Requires: ament_add_gmock builds on ament_cmake_gtest
# (gmock sources sit beside gtest) and the ament_cmake_test harness, and
# soft-finds gmock_vendor. google-mock system pkg is a soft fallback (vendor
# preferred), so it is not required.
Requires:       ros-jazzy-ament-cmake-gtest
Requires:       ros-jazzy-ament-cmake-test
Requires:       ros-jazzy-gmock-vendor

%description
The ability to add GMock-based tests in the ament buildsystem in CMake. Part of
