...
Version:        0.17.5
Release:        1%{?dist}
Summary:        pep257/pydocstyle wrapper

License:        Apache-2.0
URL:            https://github.com/ament/ament_lint
Source0:        https://github.com/ament/ament_lint/archive/refs/tags/0.17.5.tar.gz#/ros-jazzy-ament-pep257-0.17.5.tar.gz
...
%description
pep257/pydocstyle wrapper. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ament_lint-0.17.5
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ament_pep257/LICENSE LICENSE 2>/dev/null || :
