...
Version:        1.6.1
Release:        1%{?dist}
Summary:        Default set of ROS interface generators

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_defaults
Source0:        https://github.com/ros2/rosidl_defaults/archive/refs/tags/1.6.1.tar.gz#/ros-jazzy-rosidl-default-generators-1.6.1.tar.gz
...
%description
Default set of ROS interface generators. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rosidl_default_generators \
