...
Version:        0.13.6
Release:        1%{?dist}
Summary:        Command line tools for managing SROS2 keys

License:        Apache-2.0
URL:            https://github.com/ros2/sros2
Source0:        https://github.com/ros2/sros2/archive/refs/tags/0.13.6.tar.gz#/ros-jazzy-sros2-0.13.6.tar.gz
...
%description
Command line tools for managing SROS2 keys. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n sros2-0.13.6
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f sros2/LICENSE LICENSE 2>/dev/null || :
