...
Version:        2.0.4
Release:        1%{?dist}
Summary:        ROS 2 messages relating to the ROS computation graph

License:        Apache-2.0
URL:            https://github.com/ros2/rcl_interfaces
Source0:        https://github.com/ros2/rcl_interfaces/archive/refs/tags/2.0.4.tar.gz#/ros-jazzy-rosgraph-msgs-2.0.4.tar.gz
...
%description
ROS 2 messages relating to the ROS computation graph. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
