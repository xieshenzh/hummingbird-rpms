...
Version:        0.13.6
Release:        1%{?dist}
Summary:        CMake API for SROS2

License:        Apache-2.0
URL:            https://github.com/ros2/sros2
Source0:        https://github.com/ros2/sros2/archive/refs/tags/0.13.6.tar.gz#/ros-jazzy-sros2-cmake-0.13.6.tar.gz
...
%description
CMake API for SROS2. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n sros2-0.13.6
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f sros2_cmake/LICENSE LICENSE 2>/dev/null || :
