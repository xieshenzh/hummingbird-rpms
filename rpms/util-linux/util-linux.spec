...
Patch2: 0002-libmount-restrict-source-path-canonicalization-for-.patch
Patch3: 0003-libmount-pin-source-path-with-openat2-for-restricte.patch
Patch4: 0004-libmount-fix-X-mount.subdir-symlink-following-on-de.patch
Patch5: 0005-libmount-skip-post-mount-hooks-after-failed-mount-h.patch
Patch6: 0006-nsenter-unshare-add-O_CLOEXEC-to-all-open-calls.patch
