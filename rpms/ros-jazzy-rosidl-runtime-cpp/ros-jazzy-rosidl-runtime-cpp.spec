...
Version:        4.6.9
Release:        1%{?dist}
Summary:        Runtime C++ API for ROS interface types

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-runtime-cpp-4.6.9.tar.gz
...
%description
Runtime C++ API for ROS interface types. Part of the ROS 2 Jazzy rosidl interface-generation stack,
