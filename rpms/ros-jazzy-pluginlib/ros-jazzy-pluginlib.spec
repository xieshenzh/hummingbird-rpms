...
Version:        5.4.6
Release:        1%{?dist}
Summary:        A ROS 2 plugin framework using class_loader

License:        Apache-2.0
URL:            https://github.com/ros/pluginlib
Source0:        https://github.com/ros/pluginlib/archive/refs/tags/5.4.6.tar.gz#/ros-jazzy-pluginlib-5.4.6.tar.gz
...
%description
A ROS 2 plugin framework using class_loader. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
