...
Version:        0.17.5
Release:        1%{?dist}
Summary:        uncrustify wrapper

License:        Apache-2.0
URL:            https://github.com/ament/ament_lint
Source0:        https://github.com/ament/ament_lint/archive/refs/tags/0.17.5.tar.gz#/ros-jazzy-ament-uncrustify-0.17.5.tar.gz
...
%description
uncrustify wrapper. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ament_lint-0.17.5
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ament_uncrustify/LICENSE LICENSE 2>/dev/null || :
