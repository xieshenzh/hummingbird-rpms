...
Version:        8.4.4
Release:        1%{?dist}
Summary:        Code shared by the Fast DDS RMW implementations

License:        Apache-2.0
URL:            https://github.com/ros2/rmw_fastrtps
Source0:        https://github.com/ros2/rmw_fastrtps/archive/refs/tags/8.4.4.tar.gz#/ros-jazzy-rmw-fastrtps-shared-cpp-8.4.4.tar.gz
...
%description
Code shared by the Fast DDS RMW implementations. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    --base-paths rmw_fastrtps_shared_cpp \
