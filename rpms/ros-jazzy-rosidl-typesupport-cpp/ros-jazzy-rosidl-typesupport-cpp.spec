...
Version:        3.2.3
Release:        1%{?dist}
Summary:        Generate the C++ interfaces for ROS type support

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_typesupport
Source0:        https://github.com/ros2/rosidl_typesupport/archive/refs/tags/3.2.3.tar.gz#/ros-jazzy-rosidl-typesupport-cpp-3.2.3.tar.gz
...
BuildRequires:  ros-jazzy-rosidl-generator-type-description
...
%description
Generate the C++ interfaces for ROS type support. Part of the ROS 2 Jazzy rosidl interface-generation stack,
installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rosidl_typesupport-3.2.3
...
colcon build \
    ...
    --base-paths rosidl_typesupport_cpp \
