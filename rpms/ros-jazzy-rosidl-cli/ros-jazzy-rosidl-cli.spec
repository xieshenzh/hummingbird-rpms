...
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-cli-4.6.9.tar.gz
...
%description
Command line tools for ROS interface generation. Part of the ROS 2 Jazzy rosidl interface-generation stack,
