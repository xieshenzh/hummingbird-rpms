...
Version:        2.7.1
Release:        1%{?dist}
Summary:        A ROS-independent package for loading plugins at runtime

License:        Apache-2.0
URL:            https://github.com/ros/class_loader
Source0:        https://github.com/ros/class_loader/archive/refs/tags/2.7.1.tar.gz#/ros-jazzy-class-loader-2.7.1.tar.gz
...
%description
A ROS-independent package for loading plugins at runtime. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n class_loader-2.7.1
