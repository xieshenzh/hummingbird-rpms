...
Version:        4.6.9
Release:        1%{?dist}
Summary:        Parser for the ROS interface definition language (.idl)

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-parser-4.6.9.tar.gz
...
BuildRequires:  ros-jazzy-rosidl-adapter
...
%description
Parser for the ROS interface definition language (.idl). Part of the ROS 2 Jazzy rosidl interface-generation stack,
