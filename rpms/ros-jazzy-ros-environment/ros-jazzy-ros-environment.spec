...
Version:        4.2.1
Release:        1%{?dist}
Summary:        Environment variables for ROS 2

License:        Apache-2.0
URL:            https://github.com/ros/ros_environment
Source0:        https://github.com/ros/ros_environment/archive/refs/tags/4.2.1.tar.gz#/ros-jazzy-ros-environment-4.2.1.tar.gz
...
%description
Environment variables for ROS 2. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ros_environment-4.2.1
