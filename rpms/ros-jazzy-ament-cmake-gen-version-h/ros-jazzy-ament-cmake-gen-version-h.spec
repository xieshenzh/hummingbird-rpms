...
Version:        2.5.6
Release:        1%{?dist}
Summary:        Generate a C/C++ version header from a package version in ament

License:        Apache-2.0
URL:            https://github.com/ament/ament_cmake
# Upstream ships all ament_cmake_* subpackages in one monorepo tarball; this
# spec carves out ament_cmake_gen_version_h with colcon's --packages-select.
...
%description
Generate a C/C++ version header from a package version in ament. Part of the ament buildsystem for ROS 2 Jazzy, installed under
%{_libdir}/ros-jazzy.
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths ament_cmake_gen_version_h \
