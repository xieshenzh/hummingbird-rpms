...
Version:        0.2.1
Release:        1%{?dist}
Summary:        Metapackage aggregating the core ROS interface generators

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_core
Source0:        https://github.com/ros2/rosidl_core/archive/refs/tags/0.2.1.tar.gz#/ros-jazzy-rosidl-core-generators-0.2.1.tar.gz
...
%description
Metapackage aggregating the core ROS interface generators. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rosidl_core_generators \
