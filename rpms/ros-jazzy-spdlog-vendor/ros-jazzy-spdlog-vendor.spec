...
Version:        1.6.2
Release:        1%{?dist}
Summary:        Vendor package wrapping the system spdlog library

License:        Apache-2.0
URL:            https://github.com/ros2/spdlog_vendor
Source0:        https://github.com/ros2/spdlog_vendor/archive/refs/tags/1.6.2.tar.gz#/ros-jazzy-spdlog-vendor-1.6.2.tar.gz
...
%description
Vendor package wrapping the system spdlog library. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n spdlog_vendor-1.6.2
