...
Version:        3.1.1
Release:        1%{?dist}
Summary:        Code shared across ROS 2 DDS-based RMW implementations

License:        Apache-2.0
URL:            https://github.com/ros2/rmw_dds_common
Source0:        https://github.com/ros2/rmw_dds_common/archive/refs/tags/3.1.1.tar.gz#/ros-jazzy-rmw-dds-common-3.1.1.tar.gz
...
%description
Code shared across ROS 2 DDS-based RMW implementations. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rmw_dds_common-3.1.1
