...
Version:        2.15.6
Release:        1%{?dist}
Summary:        The default ROS 2 middleware (RMW) implementation selector

License:        Apache-2.0
URL:            https://github.com/ros2/rmw_implementation
Source0:        https://github.com/ros2/rmw_implementation/archive/refs/tags/2.15.6.tar.gz#/ros-jazzy-rmw-implementation-2.15.6.tar.gz
...
Requires:       ros-jazzy-rmw-fastrtps-dynamic-cpp
Requires:       ros-jazzy-ament-package

%description
The default ROS 2 middleware (RMW) implementation selector. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rmw_implementation-2.15.6
