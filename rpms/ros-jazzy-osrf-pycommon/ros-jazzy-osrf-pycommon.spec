...
Version:        2.1.7
Release:        1%{?dist}
Summary:        Commonly needed Python modules used by Open Source Robotics Foundation

License:        Apache-2.0
URL:            https://github.com/osrf/osrf_pycommon
Source0:        https://github.com/osrf/osrf_pycommon/archive/refs/tags/%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
# exec_depend: python3-importlib-metadata
Requires:       python3-setuptools
Requires:       python3-importlib-metadata
Requires:       ros-jazzy-ament-package

%description
osrf_pycommon is a collection of commonly needed Python modules (process
utilities, terminal color helpers, async subprocess wrappers) used across
Open Source Robotics Foundation projects. Installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n osrf_pycommon-%{version}
