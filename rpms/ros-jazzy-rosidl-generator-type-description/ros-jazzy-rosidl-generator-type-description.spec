...
Version:        4.6.9
Release:        1%{?dist}
Summary:        Generate type description resources for ROS interfaces

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-generator-type-description-4.6.9.tar.gz
...
%description
Generate type description resources for ROS interfaces. Part of the ROS 2 Jazzy rosidl interface-generation stack,
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rosidl_generator_type_description \
