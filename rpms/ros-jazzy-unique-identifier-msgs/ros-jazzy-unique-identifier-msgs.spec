...
Version:        2.5.1
Release:        1%{?dist}
Summary:        ROS 2 messages for universally unique identifiers

License:        Apache-2.0
URL:            https://github.com/ros2/unique_identifier_msgs
Source0:        https://github.com/ros2/unique_identifier_msgs/archive/refs/tags/2.5.1.tar.gz#/ros-jazzy-unique-identifier-msgs-2.5.1.tar.gz
...
%description
ROS 2 messages for universally unique identifiers. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n unique_identifier_msgs-2.5.1
