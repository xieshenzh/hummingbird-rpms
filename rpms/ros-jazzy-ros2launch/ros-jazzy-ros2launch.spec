...
Version:        0.26.12
Release:        1%{?dist}
Summary:        The launch command for ROS 2 CLI

License:        Apache-2.0
URL:            https://github.com/ros2/launch_ros
Source0:        https://github.com/ros2/launch_ros/archive/refs/tags/0.26.12.tar.gz#/ros-jazzy-ros2launch-0.26.12.tar.gz
...
%description
The launch command for ROS 2 CLI. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n launch_ros-0.26.12
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ros2launch/LICENSE LICENSE 2>/dev/null || :
