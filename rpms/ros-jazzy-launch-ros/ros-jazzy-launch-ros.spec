...
Version:        0.26.12
Release:        1%{?dist}
Summary:        ROS 2 specific extensions to the launch system

License:        Apache-2.0
URL:            https://github.com/ros2/launch_ros
Source0:        https://github.com/ros2/launch_ros/archive/refs/tags/0.26.12.tar.gz#/ros-jazzy-launch-ros-0.26.12.tar.gz
...
%description
ROS 2 specific extensions to the launch system. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n launch_ros-0.26.12
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f launch_ros/LICENSE LICENSE 2>/dev/null || :
