...
Version:        0.9.2
Release:        1%{?dist}
Summary:        Vendor package wrapping the system tinyxml2 library

License:        Apache-2.0
URL:            https://github.com/ros2/tinyxml2_vendor
Source0:        https://github.com/ros2/tinyxml2_vendor/archive/refs/tags/0.9.2.tar.gz#/ros-jazzy-tinyxml2-vendor-0.9.2.tar.gz
...
%description
Vendor package wrapping the system tinyxml2 library. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n tinyxml2_vendor-0.9.2
