...
Version:        2.5.6
Release:        1%{?dist}
Summary:        CMake functions to handle libraries in the ament buildsystem

License:        Apache-2.0
URL:            https://github.com/ament/ament_cmake
# Upstream ships all ament_cmake_* subpackages in one monorepo tarball; this
# spec carves out ament_cmake_libraries with colcon's --packages-select.
...
%description
CMake functions to handle libraries in the ament buildsystem. Part of the ament buildsystem for ROS 2 Jazzy, installed under
%{_libdir}/ros-jazzy.
