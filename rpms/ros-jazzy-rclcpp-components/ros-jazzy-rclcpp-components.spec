...
Version:        28.1.22
Release:        1%{?dist}
Summary:        Package containing tools for dynamically loadable components

License:        Apache-2.0
URL:            https://github.com/ros2/rclcpp
Source0:        https://github.com/ros2/rclcpp/archive/refs/tags/28.1.22.tar.gz#/ros-jazzy-rclcpp-components-28.1.22.tar.gz
...
%description
Package containing tools for dynamically loadable components. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rclcpp-28.1.22
