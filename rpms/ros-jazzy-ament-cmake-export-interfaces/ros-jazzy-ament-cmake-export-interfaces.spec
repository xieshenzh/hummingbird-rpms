...
Version:        2.5.6
Release:        2%{?dist}
Summary:        Export interfaces to downstream ament packages

License:        Apache-2.0
URL:            https://github.com/ament/ament_cmake
# Upstream ships all ament_cmake_* subpackages in one monorepo tarball; this
# spec carves out ament_cmake_export_interfaces with colcon's --packages-select.
...
%description
Export interfaces to downstream ament packages. Part of the ament buildsystem for ROS 2 Jazzy, installed under
%{_libdir}/ros-jazzy.
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths ament_cmake_export_interfaces \
