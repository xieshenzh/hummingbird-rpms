...
Version:        7.3.4
Release:        1%{?dist}
Summary:        ROS middleware abstraction interface

License:        Apache-2.0
URL:            https://github.com/ros2/rmw
Source0:        https://github.com/ros2/rmw/archive/refs/tags/7.3.4.tar.gz#/ros-jazzy-rmw-7.3.4.tar.gz
...
%description
ROS middleware abstraction interface. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
