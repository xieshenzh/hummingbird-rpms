...
Version:        0.13.2
Release:        1%{?dist}
Summary:        Runtime Python utilities for ROS interfaces

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl_runtime_py
Source0:        https://github.com/ros2/rosidl_runtime_py/archive/refs/tags/0.13.2.tar.gz#/ros-jazzy-rosidl-runtime-py-0.13.2.tar.gz
...
%description
Runtime Python utilities for ROS interfaces. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n rosidl_runtime_py-0.13.2
