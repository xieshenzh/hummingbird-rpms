...
Version:        5.3.8
Release:        1%{?dist}
Summary:        ROS 2 std_msgs interface package

License:        Apache-2.0
URL:            https://github.com/ros2/common_interfaces
Source0:        https://github.com/ros2/common_interfaces/archive/refs/tags/5.3.8.tar.gz#/ros-jazzy-std-msgs-5.3.8.tar.gz
...
%description
ROS 2 std_msgs interface package. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n common_interfaces-5.3.8
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f std_msgs/LICENSE LICENSE 2>/dev/null || :
