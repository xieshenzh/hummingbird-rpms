...
Version:        0.32.12
Release:        1%{?dist}
Summary:        The topic command for ROS 2 CLI

License:        Apache-2.0
URL:            https://github.com/ros2/ros2cli
Source0:        https://github.com/ros2/ros2cli/archive/refs/tags/0.32.12.tar.gz#/ros-jazzy-ros2topic-0.32.12.tar.gz
...
%description
The topic command for ROS 2 CLI. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ros2cli-0.32.12
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f ros2topic/LICENSE LICENSE 2>/dev/null || :
