...
Source0:        https://github.com/ament/ament_cmake/archive/refs/tags/2.5.6.tar.gz#/ros-jazzy-ament-cmake-auto-2.5.6.tar.gz
...
%description
The auto-magic functions for ease to use of the ament buildsystem in CMake. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n ament_cmake-2.5.6
