...
Version:        4.6.9
Release:        1%{?dist}
Summary:        Generate the C++ interfaces for ROS interface types

License:        Apache-2.0
URL:            https://github.com/ros2/rosidl
Source0:        https://github.com/ros2/rosidl/archive/refs/tags/4.6.9.tar.gz#/ros-jazzy-rosidl-generator-cpp-4.6.9.tar.gz
...
%description
Generate the C++ interfaces for ROS interface types. Part of the ROS 2 Jazzy rosidl interface-generation stack,
...
colcon build \
    ...
    -DBUILD_TESTING=OFF \
    --base-paths rosidl_generator_cpp \
