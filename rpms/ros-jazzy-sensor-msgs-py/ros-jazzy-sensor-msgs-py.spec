...
Version:        5.3.8
Release:        1%{?dist}
Summary:        Python utilities for working with sensor_msgs

License:        Apache-2.0
URL:            https://github.com/ros2/common_interfaces
Source0:        https://github.com/ros2/common_interfaces/archive/refs/tags/5.3.8.tar.gz#/ros-jazzy-sensor-msgs-py-5.3.8.tar.gz
...
%description
Python utilities for working with sensor_msgs. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.

%prep
%autosetup -n common_interfaces-5.3.8
# Some monorepos ship LICENSE per-subdir; stage it for %%license.
[ -f LICENSE ] || cp -f sensor_msgs_py/LICENSE LICENSE 2>/dev/null || :
