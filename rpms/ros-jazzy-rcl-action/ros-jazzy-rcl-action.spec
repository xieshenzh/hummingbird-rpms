...
Version:        9.2.11
Release:        1%{?dist}
Summary:        The ROS 2 action library on top of rcl

License:        Apache-2.0
URL:            https://github.com/ros2/rcl
Source0:        https://github.com/ros2/rcl/archive/refs/tags/9.2.11.tar.gz#/ros-jazzy-rcl-action-9.2.11.tar.gz
...
%description
The ROS 2 action library on top of rcl. Part of the ROS 2 Jazzy stack, installed under %{_libdir}/ros-jazzy.
